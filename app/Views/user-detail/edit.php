                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="container">
                            ...
                            <?php endif;?>
                            <form method="post" id="update_detail" name="update_detail" action="<?= site_url('user-detail/update') ?>" enctype="multipart/form-data">
                                <input type="hidden" name="id" id="id" value="<?php echo $user_obj['id']; ?>">
                                <div class="form-group d-flex">
                                    <label class="col-md-2">Name</label>
                                    <input type="text" name="name" placeholder="Name" class="form-control col-md-10" value="<?php echo $user_obj['name']; ?>" readonly/>
                                </div>
                                <div class="form-group d-flex">
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <input type="text" name="rfid" placeholder="RFID" class="form-control col-md-6" value="<?php echo $user_obj['rfid']; ?>" readonly/>
                                </div>
                                <div class="form-group d-flex">
                                    <label class="col-md-2">User Type</label>
                                    <select class="form-select form-control col-md-6" aria-label="Default select example" name="user_type" readonly>
